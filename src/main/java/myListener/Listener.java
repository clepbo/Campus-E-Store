...
public class Listener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		try {
			...
			String sql2 = "create table campusestock.vendor(vendorId varchar(200), vendorName varchar(200), vendorEmail varchar(200), vendorDepartment varchar(200), vendorMatricNo varchar(200), vendorUsername varchar(200), vendorPassword varchar(200), vendorBrandName varchar(200), vendorSchoolId longBlob)";
